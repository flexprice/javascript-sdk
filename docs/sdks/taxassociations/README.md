...
import { taxAssociationsListTaxAssociations } from "@flexprice/sdk/funcs/tax-associations-list-tax-associations.js";
...
**Promise\<[models.DtoListTaxAssociationsResponse](../../sdk/models/dto-list-tax-associations-response.md)\>**
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { taxAssociationsCreateTaxAssociation } from "@flexprice/sdk/funcs/tax-associations-create-tax-association.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreateTaxAssociationRequest](../../sdk/models/dto-create-tax-association-request.md)                                                                                | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.DtoTaxAssociationResponse](../../sdk/models/dto-tax-association-response.md)\>**
...
async function run() {
  const result = await flexprice.taxAssociations.getTaxAssociation("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { taxAssociationsGetTaxAssociation } from "@flexprice/sdk/funcs/tax-associations-get-tax-association.js";
...
async function run() {
  const res = await taxAssociationsGetTaxAssociation(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await flexprice.taxAssociations.updateTaxAssociation("<id>", {});
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { taxAssociationsUpdateTaxAssociation } from "@flexprice/sdk/funcs/tax-associations-update-tax-association.js";
...
async function run() {
  const res = await taxAssociationsUpdateTaxAssociation(flexprice, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await flexprice.taxAssociations.deleteTaxAssociation("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { taxAssociationsDeleteTaxAssociation } from "@flexprice/sdk/funcs/tax-associations-delete-tax-association.js";
...
async function run() {
  const res = await taxAssociationsDeleteTaxAssociation(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
