...
import { pricesCreatePrice } from "@flexprice/sdk/funcs/prices-create-price.js";
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreatePriceRequest](../../sdk/models/dto-create-price-request.md)                                                                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.DtoPriceResponse](../../sdk/models/dto-price-response.md)\>**
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { pricesCreatePricesBulk } from "@flexprice/sdk/funcs/prices-create-prices-bulk.js";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DtoCreateBulkPriceRequest](../../sdk/models/dto-create-bulk-price-request.md)                                                                                          | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.DtoCreateBulkPriceResponse](../../sdk/models/dto-create-bulk-price-response.md)\>**
...
async function run() {
  const result = await flexprice.prices.getPriceByLookupKey("<value>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { pricesGetPriceByLookupKey } from "@flexprice/sdk/funcs/prices-get-price-by-lookup-key.js";
...
async function run() {
  const res = await pricesGetPriceByLookupKey(flexprice, "<value>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { pricesQueryPrice } from "@flexprice/sdk/funcs/prices-query-price.js";
...
**Promise\<[models.DtoListPricesResponse](../../sdk/models/dto-list-prices-response.md)\>**
...
async function run() {
  const result = await flexprice.prices.getPrice("<id>");
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { pricesGetPrice } from "@flexprice/sdk/funcs/prices-get-price.js";
...
async function run() {
  const res = await pricesGetPrice(flexprice, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await flexprice.prices.updatePrice("<id>", {});
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { pricesUpdatePrice } from "@flexprice/sdk/funcs/prices-update-price.js";
...
async function run() {
  const res = await pricesUpdatePrice(flexprice, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await flexprice.prices.deletePrice("<id>", {});
...
```typescript
import { FlexpriceCore } from "@flexprice/sdk/core.js";
import { pricesDeletePrice } from "@flexprice/sdk/funcs/prices-delete-price.js";
...
async function run() {
  const res = await pricesDeletePrice(flexprice, "<id>", {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
