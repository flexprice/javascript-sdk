...
import { alertsQueryAlertLog } from "@flexprice/sdk/funcs/alerts-query-alert-log.js";
...
**Promise\<[models.DtoListAlertLogsResponse](../../sdk/models/dto-list-alert-logs-response.md)\>**
