...
> {
  const input: models.DeleteEntityIntegrationMappingRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        models.DeleteEntityIntegrationMappingRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.nil(204, z.void()),
    M.jsonErr([400, 401, 404], models.ErrorsErrorsErrorResponse$inboundSchema),
