...
/** @internal */
export const SubscriptionPauseResponse$inboundSchema: z.ZodMiniType<
...
export function subscriptionPauseResponseFromJSON(
  jsonString: string,
): SafeParseResult<SubscriptionPauseResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => SubscriptionPauseResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SubscriptionPauseResponse' from JSON`,
  );
}
