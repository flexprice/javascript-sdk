...
/** @internal */
export const Feature1$inboundSchema: z.ZodMiniType<Feature1, unknown> = z.pipe(
  z.object({
...
export function feature1FromJSON(
  jsonString: string,
): SafeParseResult<Feature1, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Feature1$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Feature1' from JSON`,
  );
}
