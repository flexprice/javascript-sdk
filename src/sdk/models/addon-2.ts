...
/** @internal */
export const Addon2$inboundSchema: z.ZodMiniType<Addon2, unknown> = z.pipe(
  z.object({
...
export function addon2FromJSON(
  jsonString: string,
): SafeParseResult<Addon2, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Addon2$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Addon2' from JSON`,
  );
}
